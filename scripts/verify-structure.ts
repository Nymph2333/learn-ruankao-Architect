...
const requiredFiles = [
  ...
  "docs/specs/027_phase6_18_offline_batch_dry_run_execution_record.md",
  "schemas/ruankaodaren-offline-batch-dry-run-execution-record.schema.json",
  "packages/domain-types/ruankaodaren-offline-batch-dry-run-execution-record.ts",
  "scripts/validate-ruankaodaren-offline-batch-dry-run-execution-record.ts",
  "data/manifests/phase6_18_offline_batch_dry_run_execution_record.json",
  "data/dry-runs/phase6_18/dry_run_record_phase6_1_batch_001.json",
  "data/dry-runs/phase6_18/dry_run_audit_log_phase6_1_batch_001.json",
  "data/dry-runs/phase6_18/dry_run_item_scope_report_phase6_1_batch_001.json",
  "data/dry-runs/phase6_18/dry_run_validation_report_phase6_1_batch_001.json",
  "docs/specs/028_phase6_19_dry_run_review_and_formal_run_approval_request.md",
  "schemas/ruankaodaren-dry-run-review-and-formal-run-approval-request.schema.json",
  "packages/domain-types/ruankaodaren-dry-run-review-and-formal-run-approval-request.ts",
  "scripts/validate-ruankaodaren-dry-run-review-and-formal-run-approval-request.ts",
  "data/manifests/phase6_19_dry_run_review_and_formal_run_approval_request.json",
  "docs/specs/029_phase6_20_formal_offline_batch_run_approval_decision.md",
  "schemas/ruankaodaren-formal-offline-batch-run-approval-decision.schema.json",
  "packages/domain-types/ruankaodaren-formal-offline-batch-run-approval-decision.ts",
  "scripts/validate-ruankaodaren-formal-offline-batch-run-approval-decision.ts",
  "data/manifests/phase6_20_formal_offline_batch_run_approval_decision.json",
  "docs/specs/030_phase6_21_formal_offline_batch_run_execution_record.md",
  "schemas/ruankaodaren-formal-offline-batch-run-execution-record.schema.json",
  "packages/domain-types/ruankaodaren-formal-offline-batch-run-execution-record.ts",
  "scripts/validate-ruankaodaren-formal-offline-batch-run-execution-record.ts",
  "data/manifests/phase6_21_formal_offline_batch_run_execution_record.json",
  "data/formal-runs/phase6_21/formal_batch_run_record_phase6_1_batch_001.json",
  "data/formal-runs/phase6_21/formal_execution_audit_log_phase6_1_batch_001.json",
  "data/formal-runs/phase6_21/formal_item_execution_result_1_3.json",
  "data/formal-runs/phase6_21/formal_post_run_validation_report_phase6_1_batch_001.json",
  "docs/specs/031_phase6_22_formal_run_review_and_closure_report.md",
  "schemas/ruankaodaren-formal-run-review-and-closure-report.schema.json",
  "packages/domain-types/ruankaodaren-formal-run-review-and-closure-report.ts",
  "scripts/validate-ruankaodaren-formal-run-review-and-closure-report.ts",
  "data/manifests/phase6_22_formal_run_review_and_closure_report.json",
  "docs/specs/032_phase7_0_ai_learning_generation_request.md",
  "schemas/ruankaodaren-ai-learning-generation-request.schema.json",
  "packages/domain-types/ruankaodaren-ai-learning-generation-request.ts",
  "scripts/validate-ruankaodaren-ai-learning-generation-request.ts",
  "data/manifests/phase7_0_ai_learning_generation_request.json",
  "docs/specs/033_phase7_1_ai_learning_generation_approval_gate.md",
  "schemas/ruankaodaren-ai-learning-generation-approval-gate.schema.json",
  "packages/domain-types/ruankaodaren-ai-learning-generation-approval-gate.ts",
  "scripts/validate-ruankaodaren-ai-learning-generation-approval-gate.ts",
  "data/manifests/phase7_1_ai_learning_generation_approval_gate.json",
  "docs/specs/034_phase7_2_ai_learning_generation_execution_plan.md",
  "schemas/ruankaodaren-ai-learning-generation-execution-plan.schema.json",
  "packages/domain-types/ruankaodaren-ai-learning-generation-execution-plan.ts",
  "scripts/validate-ruankaodaren-ai-learning-generation-execution-plan.ts",
  "data/manifests/phase7_2_ai_learning_generation_execution_plan.json",
  "docs/specs/035_phase7_3_ai_learning_generation_execution_authorization_gate.md",
  "schemas/ruankaodaren-ai-learning-generation-execution-authorization-gate.schema.json",
  "packages/domain-types/ruankaodaren-ai-learning-generation-execution-authorization-gate.ts",
  "scripts/validate-ruankaodaren-ai-learning-generation-execution-authorization-gate.ts",
  "data/manifests/phase7_3_ai_learning_generation_execution_authorization_gate.json",
  "docs/specs/036_phase7_4_ai_learning_generation_execution.md",
  "schemas/ruankaodaren-ai-learning-generation-execution.schema.json",
  "packages/domain-types/ruankaodaren-ai-learning-generation-execution.ts",
  "scripts/validate-ruankaodaren-ai-learning-generation-execution.ts",
  "data/manifests/phase7_4_ai_learning_generation_execution.json",
  "docs/specs/037_phase7_5_ai_learning_generation_human_review_request_package.md",
  "schemas/ruankaodaren-ai-learning-generation-human-review-request-package.schema.json",
  "packages/domain-types/ruankaodaren-ai-learning-generation-human-review-request-package.ts",
  "scripts/validate-ruankaodaren-ai-learning-generation-human-review-request-package.ts",
  "data/manifests/phase7_5_ai_learning_generation_human_review_request_package.json",
  "docs/specs/038_phase7_6_ai_learning_generation_human_review_result_recording_gate.md",
